...
namespace newBugTracker.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangeName()
        {
            ...
            {
                ModelState.AddModelError(string.Empty, new Exception("The application user was note found. No updates can be made."));
        ...
        public ActionResult ChangeName(ChangeNameViewModel model)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, new Exception("The application user was not found. No updates were applied."));
                return View(model);
            }
